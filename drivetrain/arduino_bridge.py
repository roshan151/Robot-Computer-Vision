...
ACK_TIMEOUT_S = float(getattr(config, "ACK_TIMEOUT_S", 0.35))
CMD_RETRIES = int(getattr(config, "CMD_RETRIES", 3))
MOVE_TIMEOUT_S = float(getattr(config, "MOVE_TIMEOUT_S", 20.0))
